 ...
 * layers/cctv.js
 *
 * Global CCTV camera layer — renders 134,000+ public traffic/road/weather
 * cameras as Cesium billboard entities with live snapshot previews on click.
 *
 * Data files (generated by server/collectors/collectCameras.mjs):
 *   public/camera-data/tiles-manifest.json   — tile index (small, loaded once)
 *   public/camera-data/tiles/{lat}_{lng}.json — 5°×5° tile files (~300 cams each)
 *
 * Visibility rules:
 *   > 3,000 km altitude  → nothing shown
 *   < 3,000 km altitude  → cameras in viewport tiles are loaded & displayed
 */
